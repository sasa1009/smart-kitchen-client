 ...
 * 食事記録情報
 * @export
 * @interface ExportFoodLogsResponse
 */
export interface ExportFoodLogsResponse {
    /**
     * 食事記録情報の配列
     * @type {Array<ExportFoodLogsResponseFoodLogs>}
     * @memberof ExportFoodLogsResponse
     */
    'food_logs': Array<ExportFoodLogsResponseFoodLogs>;
    /**
     * 
     * @type {ExportFoodLogsResponseMeta}
     * @memberof ExportFoodLogsResponse
     */
    'meta': ExportFoodLogsResponseMeta;
}
/**
 * 
 * @export
 * @interface ExportFoodLogsResponseFoodLogs
 */
export interface ExportFoodLogsResponseFoodLogs {
    /**
     * 食事記録情報のID
     * @type {number}
     * @memberof ExportFoodLogsResponseFoodLogs
     */
    'id': number;
    /**
     * 食品名
 ...
 * 追加情報
 * @export
 * @interface ExportFoodLogsResponseMeta
 */
export interface ExportFoodLogsResponseMeta {
    /**
     * 食事記録情報の総数
     * @type {number}
     * @memberof ExportFoodLogsResponseMeta
     */
    'total': number;
}
/**
 ...
 * 一括登録する食事記録情報
 * @export
 * @interface ImportFoodLogsRequest
 */
export interface ImportFoodLogsRequest {
    /**
     * 食事記録情報の配列
     * @type {Array<ImportFoodLogsRequestFoodLogs>}
     * @memberof ImportFoodLogsRequest
     */
    'food_logs': Array<ImportFoodLogsRequestFoodLogs>;
}
/**
 * 
 * @export
 * @interface ImportFoodLogsRequestFoodLogs
 */
export interface ImportFoodLogsRequestFoodLogs {
    /**
     * 食品名
     * @type {string}
     * @memberof ImportFoodLogsRequestFoodLogs
     */
    'name': string;
    /**
     * カロリー(kcal)
...
export const FoodLogsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        exportFoodLogs: async (uid: string, accessToken: string, client: string, from: string, to: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'uid' is not null or undefined
            assertParamExists('exportFoodLogs', 'uid', uid)
            // verify required parameter 'accessToken' is not null or undefined
            assertParamExists('exportFoodLogs', 'accessToken', accessToken)
            // verify required parameter 'client' is not null or undefined
            assertParamExists('exportFoodLogs', 'client', client)
            // verify required parameter 'from' is not null or undefined
            assertParamExists('exportFoodLogs', 'from', from)
            // verify required parameter 'to' is not null or undefined
            assertParamExists('exportFoodLogs', 'to', to)
            const localVarPath = `/food_logs/export`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        /**
         * 食事記録情報を一括登録する
         * @summary 食事記録情報を一括登録する
         * @param {string} uid devise-token-auth用のuid
         * @param {string} accessToken devise-token-auth用のaccess-token
         * @param {string} client devise-token-auth用のclient
         * @param {ImportFoodLogsRequest} importFoodLogsRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        importFoodLogs: async (uid: string, accessToken: string, client: string, importFoodLogsRequest: ImportFoodLogsRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'uid' is not null or undefined
            assertParamExists('importFoodLogs', 'uid', uid)
            // verify required parameter 'accessToken' is not null or undefined
            assertParamExists('importFoodLogs', 'accessToken', accessToken)
            // verify required parameter 'client' is not null or undefined
            assertParamExists('importFoodLogs', 'client', client)
            // verify required parameter 'importFoodLogsRequest' is not null or undefined
            assertParamExists('importFoodLogs', 'importFoodLogsRequest', importFoodLogsRequest)
            const localVarPath = `/food_logs/import`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(importFoodLogsRequest, localVarRequestOptions, configuration)
...
export const FoodLogsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async exportFoodLogs(uid: string, accessToken: string, client: string, from: string, to: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExportFoodLogsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.exportFoodLogs(uid, accessToken, client, from, to, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 食事記録情報を一覧取得する
         ...
         * @throws {RequiredError}
         */
        async importFoodLogs(uid: string, accessToken: string, client: string, importFoodLogsRequest: ImportFoodLogsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.importFoodLogs(uid, accessToken, client, importFoodLogsRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const FoodLogsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        exportFoodLogs(uid: string, accessToken: string, client: string, from: string, to: string, options?: any): AxiosPromise<ExportFoodLogsResponse> {
            return localVarFp.exportFoodLogs(uid, accessToken, client, from, to, options).then((request) => request(axios, basePath));
        },
        /**
         * 食事記録情報を一覧取得する
         * @summary 食事記録情報を一覧取得する
         ...
         * @throws {RequiredError}
         */
        importFoodLogs(uid: string, accessToken: string, client: string, importFoodLogsRequest: ImportFoodLogsRequest, options?: any): AxiosPromise<void> {
            return localVarFp.importFoodLogs(uid, accessToken, client, importFoodLogsRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class FoodLogsApi extends BaseAPI {
     ...
     * @memberof FoodLogsApi
     */
    public exportFoodLogs(uid: string, accessToken: string, client: string, from: string, to: string, options?: AxiosRequestConfig) {
        return FoodLogsApiFp(this.configuration).exportFoodLogs(uid, accessToken, client, from, to, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FoodLogsApi
     */
    public importFoodLogs(uid: string, accessToken: string, client: string, importFoodLogsRequest: ImportFoodLogsRequest, options?: AxiosRequestConfig) {
        return FoodLogsApiFp(this.configuration).importFoodLogs(uid, accessToken, client, importFoodLogsRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const RecipesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} limit 取得するレシピ情報の件数
         * @param {number} offset 取得をスキップするレシピ情報の件数
         * @param {string} from 取得するレシピがお気に入りに登録された期間の始期
         * @param {string} to 取得するレシピがお気に入りに登録された期間の終期
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getRecipeRanking: async (uid: string, accessToken: string, client: string, limit: number, offset: number, from: string, to: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'uid' is not null or undefined
            assertParamExists('getRecipeRanking', 'uid', uid)
            // verify required parameter 'accessToken' is not null or undefined
            assertParamExists('getRecipeRanking', 'accessToken', accessToken)
            // verify required parameter 'client' is not null or undefined
            assertParamExists('getRecipeRanking', 'client', client)
            // verify required parameter 'limit' is not null or undefined
            assertParamExists('getRecipeRanking', 'limit', limit)
            // verify required parameter 'offset' is not null or undefined
            assertParamExists('getRecipeRanking', 'offset', offset)
            // verify required parameter 'from' is not null or undefined
            assertParamExists('getRecipeRanking', 'from', from)
            // verify required parameter 'to' is not null or undefined
            assertParamExists('getRecipeRanking', 'to', to)
            const localVarPath = `/recipe_ranking`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const RecipesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecipeRanking(uid: string, accessToken: string, client: string, limit: number, offset: number, from: string, to: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetRecipesResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRecipeRanking(uid, accessToken, client, limit, offset, from, to, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * レシピ情報を一覧取得する
...
export const RecipesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipeRanking(uid: string, accessToken: string, client: string, limit: number, offset: number, from: string, to: string, options?: any): AxiosPromise<GetRecipesResponse> {
            return localVarFp.getRecipeRanking(uid, accessToken, client, limit, offset, from, to, options).then((request) => request(axios, basePath));
        },
        /**
         * レシピ情報を一覧取得する
         * @summary レシピ情報を一覧取得する
...
export class RecipesApi extends BaseAPI {
     ...
     * @memberof RecipesApi
     */
    public getRecipeRanking(uid: string, accessToken: string, client: string, limit: number, offset: number, from: string, to: string, options?: AxiosRequestConfig) {
        return RecipesApiFp(this.configuration).getRecipeRanking(uid, accessToken, client, limit, offset, from, to, options).then((request) => request(this.axios, this.basePath));
    }
